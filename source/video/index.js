                    ...
                    >
                        ...
                        <View style={[common.boxHeader]}>
                            <View style={[common.boxHeaderLeft, { flexDirection: 'row' }]}>
                                ...
                                <Text style={common.boxTitle}>{this.state.selectedTitle}</Text>
                            </View>

                            <View style={[common.boxHeaderRight]}>
                                <TouchableOpacity onPress={() => this.openRbSheet()} style={{ alignItems: 'center', justifyContent: 'center', flexDirection: 'row' }}>
                                    ...
                                    <ImageBackground
                                        ...
                                        <View style={styles.playBox}>
                                            <TouchableOpacity activeOpacity={0.9}
                                                onPress={() => navigation.navigate('VideoPlayer', { url: slide.url, title: slide.title })}
                                                style={styles.play}>
                                                <Feather name="play" size={24} color={color.white} style={styles.playIcon} />
                                            </TouchableOpacity>
                                        </View>
